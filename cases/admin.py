"""
cases/admin.py
Admin registrations — demonstrates Django's batteries-included philosophy.
Inlines allow editing related records directly from the parent admin page.
"""
from django.contrib import admin
from .models import (
    Caseworker, YoungPerson, Offence,
    Case, CaseOffence, CourtHearing,
    Program, Enrolment
)
...
class YoungPersonAdmin(admin.ModelAdmin):
    list_display = ['full_name', 'date_of_birth', 'gender', 'assigned_caseworker', 'indigenous_status']
    search_fields = ['first_name', 'last_name']
    list_filter = ['gender', 'assigned_caseworker', 'indigenous_status']
...
class OffenceAdmin(admin.ModelAdmin):
    ...
    list_filter = ['severity', 'requires_court']
    search_fields = ['name']
